...
import { A as AstroError, R as RenderUndefinedEntryError, a as createComponent, r as renderTemplate, u as unescapeHTML, U as UnknownContentCollectionError, k as renderUniqueStylesheet, l as renderScriptElement, n as createHeadAndContent, d as renderComponent } from './astro/server_BneTOg58.mjs';
import 'kleur/colors';
import * as devalue from 'devalue';
import { A as APP_BLOG, B as BLOG_BASE, C as CATEGORY_BASE, T as TAG_BASE, d as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash } from './permalinks_D56ODUJd.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DLKCx5gX.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://sistemadeinventario.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Bmu2mys1.mjs').then(n => n._);
